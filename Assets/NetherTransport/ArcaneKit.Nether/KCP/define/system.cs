...
namespace kcp
{
    public static unsafe partial class KCP
    {
        ...
        public static unsafe void memcpy(void* dst, void* src, nuint size) =>
            Buffer.MemoryCopy(src, dst, size, size);
        public static void memset(void* dst, byte value, nuint size)
        {
            var span = new Span<byte>(dst, checked((int)size));
            span.Fill(value);
        }
